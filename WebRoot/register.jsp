...
<html>
  ...
  <body>
	...
	<form  method="post" action="emp/register" id="form2">
		<div style="width: 165px; height: 96px; position: absolute;">
			...
			<p style="padding: 30px 0px 10px; position: relative;">
				...
				<input class="ipt" type="text" name="name" placeholder="请输入姓名"/><br />
			</p>
			...
			<p style="padding: 10px 0px 10px; position: relative;">
				<input class="ipt" type="text" name="positionId" placeholder="请输入岗位编号"/><br />
			</p>
			<p style="padding: 5px 0px 10px; position: relative;">
				<input class="ipt" type="text" name="departmentId" placeholder="请输入部门编号"/><br />
			</p>
		
		<div style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
			<p style="margin: 0px 35px 20px 45px;">
					<input type="submit" name="submit" style="background-color: #009Fcc;color: red" value="注册" />
			</p>
		</div>
	</form>
	</div>
